...
from typing import *
from my_pybullet_envs import utils_both as utils
...
from my_pybullet_envs.inmoov_shadow_demo_env_v4_both import InmoovShadowHandDemoEnvV4
...
for trial in range(NUM_TRIALS):
    ...
    while True:
        ...
        """ADD_WHITE_NOISE defaults to false"""
    ...
    table_id = utils.create_table(FLOOR_MU)
    # table_id_2 = utils.create_table(FLOOR_MU, side="l")
