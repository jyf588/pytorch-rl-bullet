...
class InmoovShadowHandPlaceEnvV4Det(gym.Env):
    ...
    def __init__(self,
                 ...
                 grasp_pi_name=None,
                 exclude_hard=False,
                 det_env=True   # det_env controls tx ty and ran_ind for hand pose
                 ):
    ...
    def reset_robot_object_from_sample(self, state, arm_q):
        ...
        if not self.det_env and self.init_noise:
    ...
    def sample_init_state(self):
        if self.det_env:
            ran_ind = 123       # TODO: hardcoded here
        else:
...
if __name__ == "__main__":
    env = InmoovShadowHandPlaceEnvV4Det()
