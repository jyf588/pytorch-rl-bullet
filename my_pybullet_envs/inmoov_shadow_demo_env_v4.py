...
class InmoovShadowHandDemoEnvV4:
    ...
    def get_robot_contact_txtytz_halfh_shape_obs_no_dup(self, tx, ty, tz, half_h, shape):
    ...
    def get_robot_contact_txtytz_halfh_shape_2obj6dUp_obs_nodup_from_up(
        ...
        self.get_robot_contact_txtytz_halfh_shape_obs_no_dup(tx, ty, tz, half_h, shape)
