...
g_obs = env_core.get_robot_contact_txty_halfh_obs(g_tx, g_ty, 0.055)    # TODO: hardcoded
...
p_obs = env_core.get_robot_2obj6dUp_contact_txty_halfh_obs(p_tx, p_ty, t_pos, t_quat,b_pos, b_quat, 0.055)  # TODO:hardcoded
p_obs = env_core.get_robot_2obj6dUp_contact_txty_halfh_obs(p_tx, p_ty, t_pos, t_quat,b_pos, b_quat, 0.055)
