...
# TODO: grasp v4
from my_pybullet_envs.inmoov_shadow_place_env_v7 import InmoovShadowHandPlaceEnvV7      # TODO
...
# obj sizes & frame representation & friction & obj range
# frame skip
# vision delay
...
# TODO:tmp use place v8 without dup obs soon.
# constants
...
TS = 1./240
TABLE_OFFSET = [0.2, 0.2, 0.0]     # TODO: x0.2 may collide, need to change OR reaching.
...
obj3 = {'shape':'cylinder','color':'blue','position':[0.0,-0.05,0,0],'size': 'large'} # ref 2
obj4 = {'shape':'box','color':'yellow','position':[0.3,0.1,0,0],'size': 'large'} #irrelevant
...
# sentence = "Put the small green cylinder on top of the blue cylinder left to the yellow large box"
...
a = InmoovShadowHandPlaceEnvV7(renders=False, grasp_pi_name=GRASP_PI)
a.seed(args.seed)
...
g_obs = env_core.get_robot_contact_txty_halfh_obs_nodup(g_tx, g_ty, 0.09)    # TODO: hardcoded
...
# TODO:hardcoded
p_obs = env_core.get_robot_contact_txty_halfh_2obj6dUp_obs_nodup(p_tx, p_ty, 0.09, t_pos, t_quat,b_pos, b_quat)
p_obs = env_core.get_robot_contact_txty_halfh_2obj6dUp_obs_nodup(p_tx, p_ty, 0.09, t_pos, t_quat,b_pos, b_quat)
